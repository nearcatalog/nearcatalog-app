...
To access the Websites and the Tools, you may be asked to provide certain registration details or other information. It is a condition of your use of the Websites and the Tools that all the information you provide on or through the Websites and the Tools is correct, current, complete, and that you have authorization to provide the same. You agree that all information you provide as part of any registration for the Websites and through the use of the Tools, including but not limited to through the use of any interactive features on the Services, is governed by the Privacy Policy, and you consent to all actions we and our service providers take with respect to such information consistent with the Privacy Policy. Other privacy policies may apply to the Tools run locally by you (“Third Party Privacy Policies”) and, if that is the case, it is your responsibility to carefully review, understand and adhere to those Third Party Privacy Policies.
...
All matters relating to the Websites, the Tools and these Terms of Use, and any dispute or claim arising therefrom or related thereto (in each case, including non-contractual disputes or claims), shall be governed by and construed in accordance with the law of the Delaware, United States.  
Any legal suit, action, or proceeding arising out of, or related to, Websites, the Tools and these Terms of Use shall be instituted exclusively in the courts of the Delaware, United States, although we retain the right to bring any suit, action, or proceeding against you for breach of these Terms of Use in your country of residence or any other relevant country.  
...
export const metadata: Metadata = {
  title: "Terms of Use",
  description:
    "NEAR Catalog is a community platform that provides a directory of NEAR projects. The Near Catalog Terms of Use govern the use of the Near Catalog platform, which provides access to blockchain-related tools. Users must be 18+, use the platform ethically, and are responsible for their account security and interactions. The terms may be updated at any time.",
};

export default function PrivacyPage() {
  return <Markdown remarkPlugins={[remarkGfm]}>{termOfService}</Markdown>;
}
