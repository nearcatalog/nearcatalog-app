...
export default function ShareDropdown({ project }: ShareDropdownProps) {
  ...
  return (
    <>
      ...
      { (
        <div className={`${!open ? 'invisible' : '' } absolute right-0 top-full mt-2 flex w-fit flex-col gap-2 rounded-lg bg-[#1c1b2a] p-2 shadow-lg ring-1 ring-white ring-opacity-5 focus:outline-none`}>
